CREATE OR REPLACE FUNCTION came."F_REPORTE_TARDANZA" ( codigoasignacion NUMBER,codigoprogramadetalle NUMBER ) RETURN VARCHAR2 IS
...
BEGIN
    ...
    THEN
        RETURN (total_tardanza-total_inas_tard*4);
    ELSE
        return('0');
    END IF;

END F_REPORTE_TARDANZA;
/