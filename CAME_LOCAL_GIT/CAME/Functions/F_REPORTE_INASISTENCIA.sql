CREATE OR REPLACE FUNCTION came."F_REPORTE_INASISTENCIA" ( codigoasignacion NUMBER,codigoprogramadetalle NUMBER ) RETURN VARCHAR2 IS
...
BEGIN
    ...
    THEN
        RETURN (totalinasistencias + total_inas_tard);
    ELSE
        return('0');
    END IF;

END F_REPORTE_INASISTENCIA;
/